...
image: https://aceric.vercel.app/images/me-w-ppl.jpeg
---
...
1. GTFS/GTFS-rt (see [my blog on GTFS](/posts/gtfs-101) to learn more) and NeTEx are two similar yet very separate transit data standards in terms of complexity and use. NeTEx is not only used in Europe it's now being used in Australia. I kind of wish there were on global transit standard, but with a lot of handoff and international differences, it's become hard to truly _standardize_ everything into one format.
2. There is a huge lack of exposure of transit data and transit technology in classrooms and to new learners. Most people don't understand what powers a search query on a trip planning app, and where that data is consumed, produced and transformed. Even more, this information isn't being taught in specialized urban planning or transportation engineering courses. Transit data as a concept is largely congregated through the work of organizations whether they be public or private. Further, the discussions, motions and decisions on CSV changes to GTFS are primarily led by a few "power maintainers" in MobilityData repositories.
...
7. The transit community is very well-connected, open, generally diverse and friendly. I definitely see myself in this industry for a longer time.
